...
namespace Test
{
    ...
    public class NewStringGenerator : Generator<string>
    {
        ...
        {
            string[] Skyrim = { "General Tullius, sir. The headsman is waiting. Good. Let's get this over with! Shor, Mara, Dibella, Kynareth, Akatosh. Divines, please help me. Look at him." };
            return Skyrim[random.Next(0, Skyrim.Length - 1)];
        }
    }
}
namespace Facker
